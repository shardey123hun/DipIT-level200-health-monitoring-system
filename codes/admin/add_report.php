...
<body>
    ...
    <div class="container">
        ...
        <main class="main-content">
            <br><br><br>
            <div class="tabs">
                <a href="../chat/?user=<?=$user['id']?>" class="tab active">Chat</a>
                <a href="add.php?user=<?=$user['id']?>" class="tab">Update Status</a>
            </div>
            ...
            <section class="latest-health-status">
                ...
                <div class="info-item">
                    ...
                    <span class="value"><?=$Current_patient_records['date']?>.</span>
                </div>
                <?php
    ...
    <script>
        ...
        localStorage.setItem("patient","<?=$user['id']?>" )
    </script>
