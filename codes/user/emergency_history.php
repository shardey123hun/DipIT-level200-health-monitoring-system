    ...
    <div class="container">
        <nav class="nav-panel">
            ...
            <ul class="nav-items">
                ...
                <li class="nav-item"><a href="Patients.html"><i class="fas fa-bank"></i>View Patients</a></li>
                <li class="nav-item"><a href="#"><i class="fa fa-list"></i>List of Applications</a></li>
                <li class="nav-item"><a href="#"><i class="fa fa-check"></i>Check my Statement</a></li>
